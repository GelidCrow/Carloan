...
public class Nuovo_Operatore extends Schermata{
	@FXML
	...
	protected TableView<Operatore> tw;
	protected Utente u;
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		if(u instanceof Amministratore){
			...
			informazioni.setText("L'operatore sarà aggiunto della sua sede");
	...
	public void btnconferma(ActionEvent e){
		...
		try {
			...
			presenter.processRequest("InserisciOperatore", a);
			a=(Operatore) presenter.processRequest("leggiOperatoreByCodiceFiscale", a.getCodiceFiscale());
